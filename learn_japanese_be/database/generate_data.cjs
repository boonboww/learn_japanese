...
const kanjiList = [
    ...
    { character: "二", meaning: "Nhị (Hai)", onyomi: "ニ", kunyomi: "ふた, ふた-tsu" },
    { character: "三", meaning: "Tam (Ba)", onyomi: "サン", kunyomi: "み, み-tsu" },
    { character: "四", meaning: "Tứ (Bốn)", onyomi: "シ", kunyomi: "よ, よ-tsu, よん" },
    { character: "五", meaning: "Ngũ (Năm)", onyomi: "ゴ", kunyomi: "いつ, いつ-tsu" },
    { character: "六", meaning: "Lục (Sáu)", onyomi: "ロク", kunyomi: "む, む-tsu" },
    { character: "七", meaning: "Thất (Bảy)", onyomi: "シチ", kunyomi: "なな, なな-tsu" },
    { character: "八", meaning: "Bát (Tám)", onyomi: "ハチ", kunyomi: "よう, や, や-tsu" },
    { character: "九", meaning: "Cửu (Chín)", onyomi: "キュウ, ク", kunyomi: "ここの, ここの-tsu" },
    ...
    { character: "円", meaning: "Yên (Tròn, tiền Yên)", onyomi: "エン", kunyomi: "まる-i" },
    ...
    { character: "男", meaning: "Nam (Đàn ông)", onyomi: "ダン, ナン", kunyomi: "おtoko" },
    { character: "父", meaning: "Phụ (Bố)", onyomi: "フ", kunyomi: "ちち, とう" },
    { character: "母", meaning: "Mẫu (Mẹ)", onyomi: "ボ", kunyomi: "はは, かあ" },
    { character: "先", meaning: "Tiên (Trước)", onyomi: "セン", kunyomi: "saki, まず" },
    { character: "生", meaning: "Sinh (Sống, sinh ra, học sinh)", onyomi: "セイ, ショウ", kunyomi: "い-きる, う-まれる, なm" },
    { character: "学", meaning: "Học (Học tập)", onyomi: "ガク", kunyomi: "まな-bu" },
    { character: "校", meaning: "Hiệu (Trường học)", onyomi: "コウ", kunyomi: "" },
    { character: "友", meaning: "Hữu (Bạn bè)", onyomi: "ユウ", kunyomi: "tomo" },
    { character: "本", meaning: "Bản (Sách, gốc, thon dài)", onyomi: "ホン", kunyomi: "モト" },
    { character: "毎", meaning: "Mỗi (Mỗi, mọi)", onyomi: "マイ", kunyomi: "goto" },
    { character: "年", meaning: "Niên (Năm)", onyomi: "ネン", kunyomi: "toshi" },
    ...
    { character: "食", meaning: "Thực (Ăn)", onyomi: "ショk", kunyomi: "た-べる, く-う" },
    { character: "飲", meaning: "Ẩm (Uống)", onyomi: "イン", kunyomi: "の-む" },
    ...
    { character: "出", meaning: "Xuất (Ra, đưa ra)", onyomi: "シュツ", kunyomi: "de-る, だ-す" },
    ...
    { character: "社", meaning: "Xã (Xã hội, đền thờ)", onyomi: "シャ", kunyomi: "yashiro" },
    ...
    { character: "長", meaning: "Trường (Dài, trưởng)", onyomi: "チョウ", kunyomi: "なが-ui" },
    { character: "白", meaning: "Bạch (Trắng)", onyomi: "ハク", kunyomi: "しろ, しろ-い" },
    { character: "黒", meaning: "Hắc (Đen)", onyomi: "コク", kunyomi: "くろ, くろ-ui" },
    { character: "赤", meaning: "Xích (Đỏ)", onyomi: "セキ", kunyomi: "あka, あか-い" },
    ...
    { character: "思", meaning: "Tư (Suy nghĩ)", onyomi: "シ", kunyomi: "おmo-う" },
    ...
    { character: "広", meaning: "Quảng (Rộng rãi)", onyomi: "コウ", kunyomi: "ひro-い" },
    ...
    { character: "作", meaning: "Tác (Chế tạo, sáng tác)", onyomi: "サk, サ", kunyomi: "つく-る" },
    ...
    { character: "切", meaning: "Thiết (Cắt, sắc bén)", onyomi: "セツ", kunyomi: "き-る, k-れる" },
    { character: "病", meaning: "Bệnh (Bệnh tật)", onyomi: "ビョウ", kunyomi: "ya-む, やまい" },
...
const basicVocabBase = [
    ...
    { word: "七つ", furigana: "nanatsu", romaji: "nanatsu", meaning: "Bảy cái" },
    ...
    { word: "七日", furigana: "nanoka", romaji: "nanoka", meaning: "Ngày mùng 7 / Bảy ngày" },
    ...
    { word: "二十日", furigana: "はつか", romaji: "hatsuka", meaning: "Ngày 20 / Hai mươi ngày" },
    ...
    { word: "火曜日", furigana: "kayoubi", romaji: "kayoubi", meaning: "Thứ ba" },
    ...
    { word: "日曜日", furigana: "nichiyoubi", romaji: "nichiyoubi", meaning: "Chủ nhật" },
    ...
    { word: "十二月", furigana: "juunigatsu", romaji: "juunigatsu", meaning: "Tháng 12" },
    ...
    { word: "先月", furigana: "sengetsu", romaji: "sengetsu", meaning: "Tháng trước" },
    { word: "昨年", furigana: "sakunen", romaji: "sakunen", meaning: "Năm ngoái" },
    ...
    { word: "女の子", furigana: "onnanoko", romaji: "onnanoko", meaning: "Cô bé" },
    ...
    { word: "辞書", furigana: "じしょ", romaji: "jisho", meaning: "Từ điển" },
    ...
    { word: "駅", furigana: "えki", romaji: "eki", meaning: "Nhà ga" },
    ...
    { word: "外", furigana: "そと", romaji: "soto", meaning: "Phía bên ngoài" },
    ...
    { word: "大雨", furigana: "ooame", romaji: "ooame", meaning: "Mưa to" },
    ...
    { word: "魚", furigana: "さkana", romaji: "sakana", meaning: "Cá" },
    ...
    { word: "電話", furigana: "denwa", romaji: "denwa", meaning: "Điện thoại" },
    ...
    { word: "旅行する", furigana: "りょこうする", romaji: "ryokousuru", meaning: "Đi du lịch" },
    ...
    { word: "話す", furigana: "はなす", romaji: "hanasu", meaning: "Nói chuyện / Phát biểu" },
    ...
    { word: "デパート", furigana: "đepart", romaji: "depa-to", meaning: "Trung tâm thương mại" },
...
const classifiedBasic = basicVocabBase.map((item, index) => {
    let type = "objects_lifestyle"; 
    if (index >= 0 && index <= 35) type = "numbers_counters";
    else if (index >= 36 && index <= 80) type = "time_calendar";
    else if (index >= 81 && index <= 109) type = "family_people";
    else if (index >= 110 && index <= 124) type = "body_parts";
    else if (index >= 125 && index <= 154) type = "school_work";
    else if (index >= 155 && index <= 177) type = "places_directions";
    else if (index >= 178 && index <= 195) type = "nature_weather";
    else if (index >= 196 && index <= 202) type = "animals";
    else if (index >= 203 && index <= 222) {
        const foodWords = ["飲み物", "食べ物", "牛肉", "豚肉", "鳥肉", "肉", "お茶", "紅茶"];
        const transWords = ["電車", "自動車", "自転車", "車"];
        if (foodWords.includes(item.word)) type = "food_drinks";
        else if (transWords.includes(item.word)) type = "transportation";
        else type = "objects_lifestyle";
    }
    else if (index >= 223 && index <= 255) type = "verbs";
    else if (index >= 256 && index <= 283) type = "adjectives";
    else if (index >= 284 && index <= 285) type = "colors";
    else {
        const foodWords2 = ["お菓子", "お弁当", "カレー", "コーヒー", "パン", "バター", "ミルク"];
        const transWords2 = ["タクシー", "バス", "パトカー"];
        if (foodWords2.includes(item.word)) type = "food_drinks";
        else if (transWords2.includes(item.word)) type = "transportation";
        else type = "objects_lifestyle";
    }
    return { ...item, type };
});

const wordPool = [...classifiedBasic];
...
const extraWords = [
    ...
    { word: "入学する", furigana: "nyuugakusuru", romaji: "nyuugakusuru", meaning: "Nhập học" },
    ...
    { word: "最低", furigana: "saitei", romaji: "saitei", meaning: "Tồi nhất / Thấp nhất" },
    { word: "半分", furigana: "はんぶん", romaji: "hanbun", meaning: "Một nửa" },
    ...
    { word: "空港", furigana: "kuukou", romaji: "kuukou", meaning: "Sân bay" },
...
const classifiedExtra = extraWords.map(item => {
    let type = "objects_lifestyle";
    if (item.word.endsWith("する")) {
        type = "verbs";
    } else if (["春", "夏", "秋", "冬", "季節", "空気", "天気予報", "地震", "火事", "事故", "台風", "海岸"].includes(item.word)) {
        type = "nature_weather";
    } else if (["空港", "港"].includes(item.word)) {
        type = "places_directions";
    } else if (
        item.word.endsWith("い") || 
        ["安全", "危険", "特別", "普通", "親切", "丁寧", "必要", "無理", "残念"].includes(item.word)
    ) {
        type = "adjectives";
    }
    return { ...item, type };
});
wordPool.push(...classifiedExtra);
...
const monthDaysKana = [
    "", "じゅういちにch", "じゅうににち", "じゅうさんにち", "じゅうよっか", "じゅうごにち",
    "じゅうろくにち", "じゅうしちにち", "じゅうはちにち", "じゅうくにち", "はつか",
    "にじゅういちにち", "にじゅうににち", "にじゅうさんにち", "にじゅうよっか", "にじゅうごにち",
    "にじゅうろくにch", "にじゅうしちにち", "にじゅうはちにch", "にじゅうくにち", "sanじゅうにち",
    "さんじゅういちにち"
];
...
// Numbers 101 to 350: e.g. "百一" -> "ひゃくいち" -> "hyakuichi" -> "Một trăm lẻ một"
for (let i = 101; i <= 350; i++) {
    ...
    if (remainder > 0) {
        if (tens === 0) {
            word += kanjiDigits[ones];
            furigana += (ones === 8 ? "はち" : kanaDigits[ones]);
            romaji += (ones === 8 ? "hachi" : romajiDigits[ones]);
            meaning += " lẻ " + vnDigits[ones];
        } else if (tens === 1) {
            word += "十" + kanjiDigits[ones];
            furigana += "じゅう" + (ones > 0 ? (ones === 8 ? "はち" : kanaDigits[ones]) : "");
            romaji += "juu" + (ones > 0 ? (ones === 8 ? "hachi" : romajiDigits[ones]) : "");
    ...
    wordPool.push({ word, furigana, romaji, meaning });
}
...
const finalizedWordPool = wordPool.map(item => {
    ...
    if (isDigit) {
        if (item.word.endsWith("日")) type = "time_calendar";
        else if (item.word.endsWith("年")) type = "time_calendar";
        else if (item.word.endsWith("ヶ月")) type = "time_calendar";
        else if (item.word.endsWith("時")) type = "time_calendar";
        else if (item.word.endsWith("分")) type = "time_calendar";
        else if (item.word.endsWith("時間")) type = "time_calendar";
        else if (item.word.endsWith("週間")) type = "time_calendar";
        else if (item.word.endsWith("年間")) type = "time_calendar";
    } else {
        // Kanji numbers
        const numChars = ["一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "百", "千", "万"];
        const hasNumChar = numChars.some(char => item.word.includes(char));
        if (hasNumChar) {
            type = "numbers_counters";
        }
    }
    return { ...item, type };
});
...
fs.writeFileSync(
    ...
    JSON.stringify(finalizedWordPool, null, 2),
    'utf-8'
);
